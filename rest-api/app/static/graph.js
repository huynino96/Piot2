...
function drawDailyGraph(data) {
    ...
    //Add a text element to annotate our borrowed books line
    svg.append("text")
    ...
    //Add a text element to annotate out returned books line
    svg.append("text")
...
function drawMonthlyGraph(data) {
    ...
    monthSvg.append("text").attr("x", 470).attr("y", 30).text("Book borrowed").style("font-size", "15px").attr("alignment-baseline","middle");
    monthSvg.append("text").attr("x", 470).attr("y", 60).text("Book returned").style("font-size", "15px").attr("alignment-baseline","middle");
}


//This function will display the number of borrowed books when the circle is hover
function handleBorrowLineHover(d, i) {
    ...
    svg.append("text")
        ...
        .text(function() {
        return d.borrow_count + " book(s)";  // Value of the text
        });
}


//The same as handleBorrowHover (but for returned books)
function handleReturnLineHover(d, i) {
    ...
    svg.append("text")
        ...
        .text(function() {
        return d.return_count + " book(s)";  // Value of the text
        });
}
...
//The same as handleBorrowLineOut (but for returned books)
