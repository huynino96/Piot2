window.onload = function() {
    if (window.location.pathname.indexOf('manager') > -1) {
        ...
        let borrowLine = d3.line().x(function(d) { return x(d.date) }).y(function(d) { return y(d.borrowCount) });
        let returnLine = d3.line().x(function(d) { return x(d.date) }).y(function(d) { return y(d.returnCount) });
        ...
        function drawDailyGraph(data) {
            ...
            data.forEach(function(d) {
                ...
                d.borrowCount = +d.borrowCount;
                d.returnCount = +d.returnCount;
            });

            //Set our scale to match the data
            x.domain(d3.extent(data, function(d) { return d.date; }));
            y.domain([d3.min(data, function(d) {
                return Math.min(d.borrowCount, d.returnCount) }),
                d3.max(data, function(d) {
                    return Math.max(d.borrowCount, d.returnCount) })]);
            ...
            svg.selectAll('circle.borrow')
                ...
                .attr("r", 5)
                .attr("cy", function(d) { return y(d.borrowCount) })
            ...
            svg.selectAll('circle.return')
                ...
                .attr("r", 5)
                .attr("cy", function(d) { return y(d.returnCount) })
            ...
            svg.append("text")
                .attr("transform", "translate("+(graphWidth - 10)+","+ (y(data[data.length-1].borrowCount) - 15)+")")
                .attr("dy", ".35em")
            ...
            svg.append("text")
                .attr("transform", "translate("+(graphWidth - 10)+","+(y(data[data.length-1].returnCount) - 15)+")")
                .attr("dy", ".35em")
                .attr("text-anchor", "start")
                .style("fill", "red")
                .text("Return");
        ...
        function drawMonthlyGraph(data) {
            ...
            y.domain([0, d3.max(data, function(d) { return Math.max(d.borrowCount, d.returnCount) })]);
            ...
            monthSvg.selectAll('bar.borrow')
                ...
                .attr("y", function(data) { return y(data.borrowCount) } )
                .attr("height", function(data) { return graphHeight - y(data.borrowCount) })
            ...
            monthSvg.selectAll('bar.return')
                ...
                .attr("y", function(data) { return y(data.returnCount) } )
                .attr("height", function(data) { console.log(data.returnCount); return graphHeight - y(data.returnCount) })
                .attr("width", function() { return 20 })
                .attr("fill", "blue")
        ...
        function handleBorrowLineHover(d, i) {
            ...
            svg.append("text")
                ...
                .attr("id", "b" + d.borrowCount + "-" + i)
                .text(function() {
                    return d.borrowCount + " car(s)";  // Value of the text
                });
        }
        ...
        function handleReturnLineHover(d, i) {
            ...
            svg.append("text")
                .attr("x", () => { return circle.attr("cx") - 30; })
                .attr("y", function() { return circle.attr("cy") - 25; })
                .attr("id", "r" + d.returnCount + "-" + i)
                .text(function() {
                    return d.returnCount + " car(s)";  // Value of the text
                });
        }
        ...
        function handleBorrowLineOut(d, i) {
            ...
            svg.select("#b" + d.borrowCount + "-" + i).remove()
        }
        ...
        function handleReturnLineOut(d, i) {
            ...
            svg.select("#r" + d.returnCount + "-" + i).remove()
        }
        ...
        function handleBorrowBarOut(d, i) {
            bar = d3.select(this)
                ...
                .attr("width", function() { return 20 });
            monthSvg.select("#bbar" + d.borrowCount + "-" + i).remove()
        }
        ...
        function handleReturnBarOut(d, i) {
            bar = d3.select(this)
                .style("fill", function() { return 'blue' })
                .attr("width", function() { return 20 });
            monthSvg.select("#rbar" + d.returnCount + "-" + i).remove()
        }
